...
const Modal = ({ onAddRecipe }: ModalProps) => {
  ...
  const [formData, setFormData] = useState<RecipeRow>({
    name: "",
    category: "",
  ...
  const formFields = [
    { label: "Image", type: "text", id: "image", name: "img" },
    ...
    { label: "Create Date", type: "date", id: "createDate", name: "createdAt" },
  ];
