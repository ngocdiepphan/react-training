...
const Content = ({ recipeData }: ContentProps) => {
  const CHIP_DATA = [
    ...
    },
    {
      ...
      icon: <span className="bg-reply w-14 h-14 bg-no-repeat"></span>,
    },
  ];
  ...
  return (
    <section className="mx-12 md:mx-102 lg:mx-30">
      ...
      <div className="flex flex-col mt-24 pb-37 border-b border-b-borderPrimary hover:border-b-primary md:flex-row md:pb-37 gap-24 items-center">
        {CHIP_DATA.map((item) => (
